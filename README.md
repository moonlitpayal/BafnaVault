...
|:---:|:---:|
| ![Admin Panel Desktop](screenshots/desktop_admin.png) <br> *Create projects, manage archives, and users.* | ![Grid View Desktop](screenshots/desktop_grid.png) <br> *Wide view for managing large sets of blueprints.* |
